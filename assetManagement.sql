...
values
('E001', 'John Doe', 'IT', 'john.doe@gmail.com', 'password123'),
('E002', 'Jane Smith', 'HR', 'jane.smith@gmail.com', 'password456'),
('E003', 'Alice Johnson', 'Finance', 'alice.johnson@gmail.com', 'password789'),
('E004', 'Bob Brown', 'Marketing', 'bob.brown@gmail.com', 'password101'),
('E005', 'Charlie Davis', 'Operations', 'charlie.davis@gmail.com', 'password202');

insert into assets
(asset_id, name, type, serial_number, purchase_date, location, status, owner_id) 
values
('A001', 'Laptop', 'Electronics', 'SN123456', '2028-01-15', 'Office', 'in use', 'E001'),
('A002', 'Projector', 'Electronics', 'SN654321', '2028-02-20', 'Conference Room', 'under maintenance', 'E002'),
('A003', 'Office Chair', 'Furniture', 'SN789012', '2028-03-05', 'Office', 'in use', 'E003'),
('A004', 'Desk', 'Furniture', 'SN345678', '2028-04-10', 'Office', 'available', 'E004'),
('A005', 'Company Car', 'Vehicle', 'SN901234', '2028-05-15', 'Parking Lot', 'in use', 'E005');

insert into maintenance_records
(maintenance_id, asset_id, maintenance_date, description, cost) 
values
('M001', 'A002', '2028-03-01', 'Replaced bulb', 150.00),
('M002', 'A001', '2028-02-10', 'Software update', 75.00),
('M003', 'A003', '2028-04-15', 'Repaired armrest', 50.00),
('M004', 'A004', '2028-05-01', 'Assembly', 30.00),
('M005', 'A005', '2028-06-10', 'Oil change', 100.00);

insert into asset_allocations
(allocation_id, asset_id, employee_id, allocation_date, return_date) 
values
('AL001', 'A001', 'E001', '2028-01-16', NULL),
...
values
('R001', 'A002', 'E001', '2028-03-01', '2028-03-05', '2028-03-10', 'approved'),
('R002', 'A003', 'E002', '2028-04-01', '2028-04-05', '2028-04-10', 'pending'),
('R003', 'A004', 'E003', '2028-05-01', '2028-05-05', '2028-05-10', 'canceled'),
('R004', 'A005', 'E004', '2028-06-01', '2028-06-05', '2028-06-10', 'approved'),
('R005', 'A001', 'E005', '2028-07-01', '2028-07-05', '2028-07-10', 'pending');
